...
INPATH=root://eoscms//eos/cms/store/user/amagnan/HGCalHEGeant4/gitV00-02-04/
...
do
	...
	do
		...
		./bin/validation 0 $INPATH/$p/ HGcal_version${v}_model3_BOFF_e${e}.root Digi_version${v}_model3_BOFF_e${e}.root $MYDIR/validation_e${e}.root 3 >& v${v}_p${p}_e${e}.log &
	    done
	done
    done
done
