						      ...
						      const double z) const
{
  ...
  double z3 = z2 * z;
  double z4 = z3 * z;
  double r100 = -z4*1.60163e-06 + z3*2.50640E-03 - z2*1.46943e+00 + z*3.82025e+02 - 3.705690e+04;
  double r200 = -z4*4.43240E-07 + z3*7.70078E-04 - z2*4.97013E-01 + z*1.40778E+02 - 1.46340E+04;
